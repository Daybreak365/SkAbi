...
public class CondHasAbility extends Condition {
	public static final String[] patterns = {"%participant% has ability", "%participant% does( not|n't) have ability"};
	...
	public boolean check(Event event) {
		...
		return Negated.value(isNegated(), participant.hasAbility());
	}
