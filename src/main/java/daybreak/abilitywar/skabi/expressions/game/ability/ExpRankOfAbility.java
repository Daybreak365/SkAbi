...
public class ExpRankOfAbility extends SimpleExpression<String> {
	public static final String[] patterns = {"%ability%'s rank", "rank of %ability%", "%ability%'s rank name", "rank name of %ability%"};
	...
	protected String[] get(Event event) {
		...
		return new String[] {name ? ability.getRank().getRankName() : ability.getRank().name()};
	}
